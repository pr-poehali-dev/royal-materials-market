...
const timeline = [
  { year: "1887", event: "Основание торгового дома «Царскій Матеріалъ» в Санкт-Петербурге купцом первой гильдии Николаем Ильичём Строгановым." },
  ...
  { year: "2015", event: "Получение статуса официального дистрибьютора Mapei, Litokol и Sika в России." },
